<div class="space-y-6">
    ...
    <div class="flex flex-row gap-4 mb-6 mx-1 overflow-x-hidden">
        <div
            class="flex-1 bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg shadow hover:from-blue-100 hover:to-blue-200 transition-all duration-300">
            <h3 class="text-lg font-semibold text-black">Completed Projects</h3>
            <p class="text-2xl font-bold text-black">
                {{ Auth::user()->volunteer->activities()->wherePivot('approval_status', 'approved')->count() }}</p>
        </div>
        <div
            class="flex-1 bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-lg shadow hover:from-green-100 hover:to-green-200 transition-all duration-300">
            <h3 class="text-lg font-semibold text-black">Hours Contributed</h3>
            <p class="text-2xl font-bold text-black">
                {{ Auth::user()->volunteer->activities()->wherePivot('approval_status', 'approved')->sum('duration') }}
            </p>
        </div>
        {{-- <div class="flex-1 bg-gradient-to-br from-purple-50 to-purple-100 p-4 rounded-lg shadow hover:from-purple-100 hover:to-purple-200 transition-all duration-300">
            <h3 class="text-lg font-semibold text-black">Organizations Following</h3>
            <p class="text-2xl font-bold text-black">{{ Auth::user()->volunteer->followedOrganizations->count() }}</p>
        </div> --}}
        <div
            class="flex-1 bg-gradient-to-br from-indigo-50 to-indigo-100 p-4 rounded-lg shadow hover:from-indigo-100 hover:to-indigo-200 transition-all duration-300">
            <h3 class="text-lg font-semibold text-black">Idea Interactions</h3>
            <p class="text-2xl font-bold text-black">{{ Auth::user()->volunteer->idea_interactions_count }}</p>
        </div>
    </div>
    ...
    <div class="bg-white overflow-hidden shadow-xl rounded-lg my-6">
        <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-800 text-center">Activities</h2>
        </div>
