<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div id="organization-fields" style="display: none;">
            ...
            <div class="mt-4">
                <x-text-input id="org_address" class="block mt-1 w-full" type="text" name="org_address" :value="old('org_address')" required placeholder="Organization Address" />
                <x-input-error :messages="$errors->get('org_address')" class="mt-2" />
            </div>

            <!-- Organization Phone -->
            <div class="mt-4">
                <x-text-input id="org_phone" class="block mt-1 w-full" type="tel" name="org_phone" :value="old('org_phone')" required placeholder="Organization Phone" />
