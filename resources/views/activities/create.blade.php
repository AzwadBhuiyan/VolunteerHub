            ...
            <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    <div class="bg-gradient-to-r from-gray-800 via-gray-900 to-black px-6 py-4 rounded-t-lg shadow-lg">
                        <h2
                            class="font-semibold text-2xl bg-gradient-to-r from-green-400 to-blue-500 text-transparent bg-clip-text tracking-wide animate-gradient">
                            ...
                            <div class="space-y-6">
                                    ...
                                    <div>
                                        <div class="relative">
                                            <input type="text" id="date" name="date"
                                                ...
                                                :value="old('date')" required placeholder="Select Date" />
                                        </div>
                                        <link rel="stylesheet"
                                ...
                                <div>
                                    <textarea id="address" name="address"
                                        class="block w-full h-20 rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                                        required placeholder="Project Address">{{ old('address') }}</textarea>
                                ...
                                <div>
                                    <div class="relative">
                                        ...
                                        <x-text-input id="google_maps_link" class="block w-full pl-10" type="text"
                                ...
                                <div class="w-full mb-6">
                                    <div class="relative w-full">
                                        <input type="text" id="deadline" name="deadline"
                                            ...
                                            :value="old('deadline')" required readonly
