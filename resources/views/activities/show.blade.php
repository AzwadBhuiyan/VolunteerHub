    ...
    <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 min-h-screen">
        <div class="p-1 sm:p-8 bg-white shadow sm:rounded-lg">
            <div class="p-2 bg-white border-b border-gray-200">
                ...
                <div class="p-3 flex items-center space-x-4 border-b border-gray-100">
                    ...
                    @else
                        <div class="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center">
                            <span class="text-lg font-bold text-gray-600">{{ substr($activity->organization->org_name, 0, 1) }}</span>
                        </div>
                    @endif
                ...
                <p class="text-gray-700 text-sm mb-2 leading-relaxed">{{ $activity->description }}</p>
