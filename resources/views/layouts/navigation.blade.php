<nav class="flex justify-between items-center">
    ...
    <div class="nav-links flex-grow flex justify-center">
        ...
        <a href="#" class="relative text-gray-500 hover:text-gray-700 px-3 py-2 rounded-md text-sm font-medium {{ request()->routeIs('profile.public', Auth::id()) ? 'text-blue-500' : '' }}">
            <div class="icon-container">
                <svg class="h-5 w-5 {{ request()->routeIs('profile.public', Auth::id()) ? 'fill-current text-blue-500' : 'fill-none' }}" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                    <path d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                </svg>
                <span class="tooltip">{{ __('Profile') }}</span>
            </div>
            <div class="active-underline {{ request()->routeIs('profile.public', Auth::id()) ? 'active' : '' }}"></div>
        </a>

        <a href="{{ route('dashboard') }}" class="relative text-gray-500 hover:text-gray-700 px-3 py-2 rounded-md text-sm font-medium {{ request()->routeIs('dashboard') ? 'text-blue-500' : '' }}">
            <div class="icon-container">
        ...
        <!-- New Favorites Icon -->
        <a href="#" class="relative text-gray-500 hover:text-gray-700 px-3 py-2 rounded-md text-sm font-medium">
            <div class="icon-container">
