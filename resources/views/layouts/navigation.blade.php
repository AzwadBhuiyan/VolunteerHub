<nav class="flex justify-between items-center">
    ...
    <div class="nav-links flex-grow flex justify-center">
        @auth
            ...
            <!-- New Favorites Icon -->
            <a href="{{ route('favorites.edit') }}" class="relative text-gray-500 hover:text-gray-700 px-3 py-2 rounded-md text-sm font-medium {{ request()->routeIs('favorites.edit') ? 'text-blue-500' : '' }}">
                <div class="icon-container">
                    <!-- Favorites icon with active color -->
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" 
                        fill="{{ request()->routeIs('favorites.edit') ? '#007bff' : 'none' }}" 
                        stroke="currentColor" 
                        class="h-7 w-7 nav-icon {{ request()->routeIs('favorites.edit') ? 'active-icon' : '' }}" 
                        viewBox="0 0 24 24">
                ...
                <div class="active-underline {{ request()->routeIs('favorites.edit') ? 'active' : '' }}"></div>
            </a>
