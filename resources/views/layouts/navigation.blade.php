    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-12">
            ...
            <div class="hidden sm:flex sm:items-center">
                ...
                <!-- check user type for specific info -->
                @php
                    $profile = Auth::user()->volunteer ?? Auth::user()->organization;
                    $profileUrl = $profile ? $profile->url : '';
                @endphp
                <a href="{{ route('profile.public', $profileUrl) }}" class="text-gray-500 hover:text-gray-700 px-3 py-2 rounded-md text-sm font-medium">
                    <svg class="h-5 w-5" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
