    ...
    <div class="max-w-7xl mx-auto px-1 sm:px-6 lg:px-8 space-y-6">
        ...
        <main class="bg-white shadow-md p-1">
            ...
            <div style="background: linear-gradient(to right, #3b82f6, #8b5cf6);"
                class="text-white p-8 rounded-lg shadow-lg mb-8">
                <h1 class="text-3xl font-bold mb-4">Welcome to {{ config('app.name', 'Laravel') }}</h1>
                <p class="text-lg">Join our community and make a difference!</p>
            </div>
            ...
            <div class="flex justify-center gap-6 mb-8 relative">
                ...
                <div class="stat-item flex-1 text-center p-6 relative flex flex-col items-center">
                    <h2 class="text-2xl font-bold text-blue-600 mb-1">
                        <span id="totalHours" data-target="{{ $totalHours }}">0</span>
                    </h2>
                    <h3 class="text-md font-bold mt-auto">Hours of Activity</h3>
                </div>

                <!-- Registered Volunteers -->
                <div
                    class="stat-item flex-1 text-center p-6 relative flex flex-col items-center border-l border-gray-300">
                    <h2 class="text-2xl font-bold text-green-600 mb-1">
                        <span id="totalVolunteers" data-target="{{ $totalVolunteers }}">0</span>
                    </h2>
                    <h3 class="text-md font-bold mt-auto">Active Volunteers</h3>
                </div>

                <!-- Completed Activities -->
                <div
                    class="stat-item flex-1 text-center p-6 relative flex flex-col items-center border-l border-gray-300">
                    <h2 class="text-2xl font-bold text-purple-600 mb-1">
                        <span id="totalCompletedActivities" data-target="{{ $totalCompletedActivities }}">0</span>
                    </h2>
                    <h3 class="text-md font-bold mt-auto">Successful Programs</h3>
                </div>
            </div>
            ...
            <!-- Idea Board Link -->
            <div style="background: linear-gradient(to right, #3b82f6, #8b5cf6);"
                class="text-white p-4 rounded-lg shadow-lg mb-8 flex flex-col items-center justify-center mt-4 mb-4">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                    ...
                    <path d="M8 1a7 7 0 1 0 0 14A7 7 0 0 0 8 1zm0 12.93A5.93 5.93 0 1 1 8 2.07 5.93 5.93 0 0 1 8 13.93z"
                        fill="{{ request()->routeIs('idea_board.index') ? '#007bff' : 'currentColor' }}"
                        stroke="{{ request()->routeIs('idea_board.index') ? '#007bff' : 'currentColor' }}"
                        stroke-width="0.5" />
                    <path
                ...
                <p class="text-lg text-center mb-2">Discover and contribute to innovative ideas!</p>
                <button
                    class="relative inline-flex items-center justify-center p-0.5 me-2 overflow-hidden text-sm font-medium text-white rounded-lg group bg-transparent hover:bg-black border border-white text-white rounded-md focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
